...
with gzip.open("./tsvFiles/AllGEO.tsv.gz", "rt", encoding="utf-8") as read_file: 
    with open("./tsvFiles/filtered_AllGEO.tsv", "w", encoding="utf-8") as filtered_file:
        with open("./tsvFiles/filtered_AllGEO_ids.tsv", "w", encoding="utf-8") as ids_file:
...
with gzip.open("./tsvFiles/gte-large.tsv.gz", "rt", encoding="utf-8") as read_file: 
    with open("./tsvFiles/gte_ids.tsv", "w", encoding="utf-8") as write_file:
